...
//   const urlForFetch = () => {
//     if (city && state) {
//     //   return `/business/list/businesses_from_location?city=${city}&state=${state}`;
//     // } else if (categoryId) {
//     //   return `/business/list/category/${categoryId}`;
//     // } else if (searchTerm) {
//     //   return `/search?query=${searchTerm}`;
//     // } else {
//     //   return `/business/list/businesses_from_location`; // Default city
//     // }
//   };
